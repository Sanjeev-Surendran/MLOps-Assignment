...
def test_map_categorical_vars():
    """_summary_
    This function checks if map_categorical_vars function is working properly by
    comparing its output with test cases provided in the db in a table named
...
def test_interactions_mapping():
    """_summary_
    This function checks if interactions_mapping function is working properly by
    comparing its output with test cases provided in the db in a table named
